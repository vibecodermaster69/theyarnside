  ...
  return (
    <main className="shop-page">
      ...
      <style jsx>{`
        ...
        .catalogue-colours { margin: -4px 0 12px; }.catalogue-colours > span { display:block; margin-bottom:7px; color:rgba(75,58,50,.7); font-size:11px; }.catalogue-colours > div { display:flex; flex-wrap:wrap; gap:8px; }.catalogue-colour { width:25px; height:25px; border:2px solid var(--white); outline:1px solid rgba(75,58,50,.25); border-radius:50%; cursor:pointer; color:var(--cocoa); font-size:16px; line-height:1; }.catalogue-colour.sold-out { opacity:.45; cursor:not-allowed; }
      `}</style>
    </main>
  );
}
